...
namespace Maticsoft.Common
{
    public class Cryptography
    {
        ...
        {
            string jsonStr = HttpRequestUtil.RequestUrl(string.Format("https://qyapi.weixin.qq.com/cgi-bin/department/create?access_token={0}", access_token));
