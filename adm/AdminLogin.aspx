<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminLogin.aspx.cs" Inherits="NH.Web.adm.AdminLogin" %>
...
<head id="Head1" runat="server">
    <title></title>
    <link href="Style/AdminLogin.css" rel="stylesheet" type="text/css" />
</head><body>
    ...
    <div id="login">
            ...
            <div id="middle">
                ...
                <div id="user_login">
                       ...
                       <p>验证码：<asp:TextBox ID="txtCode" runat="server" /><img id="validate" src="<%=NH.Web.Urls.VCode("adm") %>" alt="验证码" title="点击刷新验证码" onclick="this.src='<%=NH.Web.Urls.VCode("adm") %>&_='+Math.random()"/></p>
