<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CompanyAlbumForVerify.aspx.cs" Inherits="NH.Web.adm.Company.CompanyAlbumForVerify" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            objTbList.datagrid({
                title: '企业相册审核',
                toolbar: '#toolbar',
                url: 'CompanyAlbumForVerify.aspx?action=GetList&ajax=1',
        ...
        function VerifyAlbum(id, status, objLink) {
            ...
            $.ajax({
                url: 'CompanyAlbum.aspx?id=' + id + '&ajax=1',
