<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CompanyIdentityVerifyList.aspx.cs" Inherits="NH.Web.adm.Company.CompanyIdentityVerifyList" %>
    ...
    <script type="text/javascript">
        ...
        function OpenWin(id, realname) {
            ...
            win.window({
                ...
                maximized: true,
                modal: true,
                content: createFrame('CompanyPanel.aspx?id=' + id + '&selected=CompanyIdentityVerify'),
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            objTbList.datagrid({
                title: '企业实名认证审核',
                toolbar: '#toolbar',
                url: 'CompanyIdentityVerifyList.aspx?action=GetList&ajax=1',
        ...
        function Show(id) {
            ...
            OpenWin(row.CompanyID, row.LoginName + (row.CompanyName != "" ? "[" + row.CompanyName + "]" : ""));
            return false;
        }
