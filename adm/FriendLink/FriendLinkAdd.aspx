<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FriendLinkAdd.aspx.cs" Inherits="NH.Web.adm.FriendLink.FriendLinkAdd" %>
...
<body>
    ...
    <div id="Add">
        <div class="frmborder">
            <p>
                <a href="FriendLink.aspx">友情链接管理</a> -> 添加</p>
        </div>
        <table width="100%" cellpadding="0" cellspacing="0" class="utable">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox runat="server" ID="txtUrl">http://</asp:TextBox>
                </td>
            </tr>
            <tr>
                <th>
