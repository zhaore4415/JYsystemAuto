<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PersonWorksForVerify.aspx.cs"
    Inherits="NH.Web.adm.Person.PersonWorksForVerify" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            objTbList.datagrid({
                title: '待审核作品',
                toolbar: '#toolbar',
                url: 'PersonWorksForVerify.aspx?action=GetList&ajax=1',
                ...
                buttons: [
                        {
                            ...
                            iconCls: 'icon-ok',
                            text: "推荐",
                            disabled: (row.IsCommend == "True" ? true : false),
                            handler: function () { SetCommendWorks(row.Id, 1); }
                        }, {
                            id: 'btnCommendNo',
                            iconCls: 'icon-no',
                            text: "取消推荐",
                            disabled: (row.IsCommend == "False" ? true : false),
