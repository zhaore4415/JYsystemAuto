<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PersonIdentityVerifyList.aspx.cs" Inherits="NH.Web.adm.Person.PersonIdentityVerifyList" %>
    ...
    <script type="text/javascript">
        ...
        function OpenWin(id, realname) {
            ...
            win.window({
                ...
                maximized: true,
                modal: true,
                content: createFrame('PersonPanel.aspx?id=' + id + '&selected=PersonIdentityVerify'),
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            objTbList.datagrid({
                title: '人才实名认证审核',
                toolbar: '#toolbar',
                url: 'PersonIdentityVerifyList.aspx?action=GetList&ajax=1',
