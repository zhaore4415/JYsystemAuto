<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SolutionModify.aspx.cs" Inherits="NH.Web.adm.Article.SolutionModify" %>
...
<body>
    ...
    <div id="Add">
    <div class="frmborder">
            <p><a href="SolutionList.aspx">策划方案管理</a>->修改</p>
        </div>
        <table width="100%" cellpadding="0" cellspacing="0" class="utable">
            ...
            <tr>
                ...
                <td>
                    <asp:FileUpload runat="server" ID="file" /> <asp:Label runat="server" ID="lbFilename"></asp:Label>
                </td>
            </tr>
            <tr>
                <th>
