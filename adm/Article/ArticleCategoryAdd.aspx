<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ArticleCategoryAdd.aspx.cs" Inherits="NH.Web.adm.Article.ArticleCategoryAdd" %>
    ...
    <div class="frmborder">
        ...
        <table width="100%" cellpadding="0" cellspacing="0" class="utable">
            ...
            <tr>
                <th>是否可以删除：</th>
                <td>
                <asp:DropDownList runat="server" ID="ddlCanDelete">
