<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SolutionAdd.aspx.cs" Inherits="NH.Web.adm.Article.SolutionAdd" %>
...
<body>
    ...
    <div id="Add">
    <div class="frmborder">
            <p><a href="SolutionList.aspx">策划方案管理</a>->添加</p>
        </div>
        <table width="100%" cellpadding="0" cellspacing="0" class="utable">
            ...
            <tr>
                ...
                <td><%--<asp:Editor runat="server" ID="txtcontent" BasePath="/adm/OnflyEditor/" Height="220px" />--%>
