...
{
    public partial class HrList : WebBase.Free //WebBase.List
    {
        ...
        {
            Response.Redirect("HrList.aspx?key=" + txtKey.Text.Trim() + "&cid=" + ddlCategory.SelectedValue);
        }
            ...
            if (!string.IsNullOrEmpty(strids))
            {
                ...
                for (int i = 0; i < ids.Length; i++)
                {
                    ...
                    if (model != null)
                    {
                        ...
                        System.IO.File.Delete(Server.MapPath("/Upload/HrTools/") + model.Files);
                    }
                }
            }
