<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HrList.aspx.cs" Inherits="NH.Web.adm.Article.HrList" %>
...
<body>
    <div id="List">
        ...
        <div class="frmborder">
            ...
            <input type="button" value="添加" class="btnSmall" onclick="window.location.href='HrAdd.aspx'" />
        </div>
        <asp:Repeater ID="rptList" runat="server">
            ...
            <ItemTemplate>
                <tr class="tr">
                    ...
                    <td>
                        <a href="HrModify.aspx?id=<%#Eval("Id")%>">编辑</a> | <a href="#" onclick="javascript:return DeleteOne(<%#Eval("Id")%>)">删除</a>
                    </td>
                </tr>
            </ItemTemplate>
            <FooterTemplate>
