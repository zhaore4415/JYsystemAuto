<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmailConfigModify.aspx.cs" Inherits="NH.Web.adm.system.EmailConfigModify" %>
...
<body>
    ...
    <div id="Add">
        ...
        <table width="100%" cellpadding="0" cellspacing="0" class="utable">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox runat="server" ID="txtPassword"></asp:TextBox>(为空则不修改)
                </td>
            </tr>
            <tr>
                <th>
                ...
                <td>
                    <asp:TextBox runat="server" ID="txtPort"></asp:TextBox>(数字)
                </td>
            </tr>
    ...
    <script type="text/javascript">
        $('#txtAccount,#txtPassword').attr('autocomplete', 'off');
    </script>
    <%txtAccount.Attributes.Add("onclick", "alert('click')"); %>
</body>
</html>
