...
namespace NH.BLL
{
    ...
    public partial class Queryorder
    {
        ...
        {
            return DAL.Queryorder.Exists(model);
        }
        #endregion
        ...
        {
            return DAL.Queryorder.Add(model);
        ...
        {
            return DAL.Queryorder.Update(model);
        }
        #endregion
        ...
        {
            return DAL.Queryorder.Delete(Id);
        }
        #endregion
        ...
        {
            return DAL.Queryorder.DeleteList(Idlist);
        }
        #endregion
        ...
        public static NH.Model.Queryorder GetModel(int Id)
        {
            ...
            return DAL.Queryorder.GetModel(Id);
        }
        #endregion
        ...
        {
            return DAL.Queryorder.GetModel(model);
        }
        #endregion
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public static NH.Model.Queryorder GetModelByCache(int Id)
        {

            string CacheKey = "QueryorderModel-" + Id;
            object objModel = Maticsoft.Common.DataCache.GetCache(CacheKey);
            if (objModel == null)
            {
                try
                {
                    objModel = DAL.Queryorder.GetModel(Id);
                    if (objModel != null)
                    {
            ...
            return (NH.Model.Queryorder)objModel;
        }
        #endregion
        ...
        {
            return DAL.Queryorder.OneAmount(strWhere);
        }
        #endregion
        ...
        {
            return DAL.Queryorder.TwoAmount(strWhere);
        }
        #endregion


        #region   一级会员提成  加  二级会员提成
        /// <summary>
        /// 获得下二级会员金额
        /// </summary>
        public static string onePlustwoAmount(string strWhere1, string strWhere2)
        {
            return DAL.Queryorder.onePlustwoAmount(strWhere1, strWhere2);
        }
        #endregion
        ...
        {
            return DAL.Queryorder.GetList(strWhere);
        }
        #endregion
        ...
        {
            return DAL.Queryorder.GetList(Top, strWhere, filedOrder);
        }
        #endregion
        ...
        /// 获得数据列表
        /// </summary>
        public static List<NH.Model.Queryorder> GetModelList(string strWhere)
        {
            DataSet ds = DAL.Queryorder.GetList(strWhere);
        ...
        /// 获得数据列表
        /// </summary>
        public static List<NH.Model.Queryorder> DataTableToList(DataTable dt)
        {
            List<NH.Model.Queryorder> modelList = new List<NH.Model.Queryorder>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                NH.Model.Queryorder model;
        ...
        {
            return DAL.Queryorder.GetListByPage(strWhere, orderField, orderby, pageIndex, pageSize, ref count);
        }
        ...
        {
            return DAL.Queryorder.GetListByPage2(strWhere, orderField, orderby, pageIndex, pageSize, ref count);
        }
    }
}