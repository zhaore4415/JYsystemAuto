...
namespace NH.DAL
{
	...
	public static partial class UserRole
	{
		...
		public static bool Exists(NH.Model.UserRole model)
		{
			...
			strSql.Append("select count(1) from [UserRole](nolock)");
		...
		public static int Add(NH.Model.UserRole model)
		{
            ...
            string strSql = string.Format("insert into [UserRole] ({0}) values ({1})", colList.ToString().TrimEnd(','), colParamList.ToString().TrimEnd(','));
		...
		/// 获取SQL及参数
		/// </summary>
		public static string GetSql(NH.Model.UserRole model,ref SqlParameter[] parameters,bool isUpdate)
		{
			StringBuilder colList = new StringBuilder();
		...
		{
			NH.Model.UserRole model = new NH.Model.UserRole();
			model.Id = Id;
