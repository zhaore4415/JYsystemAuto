    ...
    public static partial class Car
    {
        ...
        public static int Add(NH.Model.Car model)
        {
            ...
            if (model.ChuShou.HasValue)
            {
                ...
                parameter = new SqlParameter("@ChuShou", SqlDbType.Decimal, 9);
            ...
            string strSql = string.Format("insert into [Car] ({0}) values ({1})", colList.ToString().TrimEnd(','), colParamList.ToString().TrimEnd(','));
        ...
        /// 获取SQL及参数
        /// </summary>
        public static string GetSql(NH.Model.Car model, ref SqlParameter[] parameters, bool isUpdate)
        {
            StringBuilder colList = new StringBuilder();
            ...
            if (model.ChuShou.HasValue)
            {
                ...
                SqlParameter parameter = new SqlParameter("@ChuShou", SqlDbType.Decimal, 9);
                parameter.Value = model.ChuShou.Value;
                paramList.Add(parameter);
            }
        ...
        {
            NH.Model.Car model = new NH.Model.Car();
            model.Id = Id;
        ...
        public static NH.Model.Car GetModel(NH.Model.Car model)
        {
            SqlParameter[] parameters = null;
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select [Id], [Status], [KeJiFen], [PName], [Num], [ChuShou], [CategoryID], [CategoryPath], [UId], [PId], [OrderNumber] ");
