...
namespace WxPayAPI
{
    public class NativePay
    {
        ...
        */
        ...
        //    data.SetValue("product_id", productId);//商品ID,订单ID
        ...
        * @return 模式二URL
        */
        public string GetPayUrl(string productId, string body, string attach, string amount, string goods_tag)
        {
            ...
            data.SetValue("total_fee", amount);//总金额这里 数字1 表示 是 1分钱 ，所以传值时 须* 100
