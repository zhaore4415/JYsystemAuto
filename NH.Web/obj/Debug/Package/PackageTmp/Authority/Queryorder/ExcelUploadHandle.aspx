...
<body>
    <%--<div id="open_load" class="easyui-window" title="" style="border: none" data-options="modal:true,closed:true,collapsible:false,minimizable:false,maximizable:false,closable:false,draggable:false,resizable:false,"
        style="width: 100px; height: 100px; padding: 1px;">
        <img src="../../images/load.gif"  width="100" height="100" id="imgLoading" />
    </div>--%>
