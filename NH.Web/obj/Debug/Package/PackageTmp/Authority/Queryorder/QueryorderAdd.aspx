<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QueryorderAdd.aspx.cs" Inherits="NH.Web.Authority.Queryorder.QueryorderAdd" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function onSave() {
            ...
            $.ajax({
                type: "post",
                url: "../../Ajax/Queryorder/QueryorderAdd.ashx?action=add",
                dataType: "json",
        ...
        <div class="modal-body">
            ...
            <div class="form-horizontal" role="form">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="txtLoginName" placeholder="请输入会员名">
                    </div>
                </div>
                <div class="form-group">
                    <label for="txtOrderNumber" class="col-sm-2 control-label"><span class="myform-star">*</span>订单号</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="txtOrderNumber" placeholder="请输入订单号">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        ...
                        <input type="text" class="form-control" id="txtProducts" placeholder="请输入商品名称，用“,” 逗号隔开，如“手机,电脑,充电器”">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        ...
                        <input type="text" class="form-control" id="txtBabynumbers" placeholder="请输入单个商品数量用“,” 逗号隔开，如“1,2,5”">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        ...
                        <input type="text" class="form-control" id="txtAmounts" placeholder="请输入每个商品金额，用“,” 逗号隔开，如“10.20,100,51.50”">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        <a id="ibtnSave" class="btn btn-primary" clientidmode="Static" href="javascript:void(0)" onclick="onCheckData()">提交</a>
