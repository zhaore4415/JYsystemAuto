<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BuMenInfoAdd.aspx.cs" Inherits="NH.Web.adm.Authority.BuMen.BuMenInfoAdd" %>
                ...
                <td colspan="2">
                    <span style="float: left; background-image: url(../images/main_hl2.gif); width: 15px;
                        background-repeat: no-repeat; height: 47px"></span><span style="padding-right: 10px;
                            ...
                            height: 47px; text-align: center;">添加部门</span><span style="float: left; background-image: url(../images/main_hr.gif);
