...
{
    public partial class SolutionCategoryAdd : WebBase.Edit
    {
        int type = 6;
        ...
        private void Show()
        {
            if (Request.QueryString["id"] != null)
            {
                ...
                if (model == null)
                {
                    Response.Redirect("SolutionCategory.aspx");
                }
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            if (Request.QueryString["id"] == null)
            {
                ...
                {
                    MessageBox.ShowAndRedirect("添加成功", "SolutionCategory.aspx");
                }
                else
                {
            ...
            else
            {
                ...
                {
                    MessageBox.ShowAndRedirect("修改成功", "SolutionCategory.aspx");
                }
                else
                {
