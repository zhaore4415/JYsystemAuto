<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Article.aspx.cs" Inherits="NH.Web.adm.Article.Article" %>
        ...
        <asp:Repeater ID="rptList" runat="server">
            ...
            <ItemTemplate>
                <tr class="tr">
                    ...
                    <td>
                        <%# (int)Eval("Status") == 1 ? "开启" : "<font color='red'>关闭</font>"%>
                    </td>
                    <td>
                        <%# Eval("AddTime")%>
                    </td>
