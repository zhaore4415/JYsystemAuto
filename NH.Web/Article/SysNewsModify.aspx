<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SysNewsModify.aspx.cs" Inherits="NH.Web.adm.Article.SysNewsModify" %>
    ...
    <div class="frmborder">
        ...
        <table width="100%" cellpadding="0" cellspacing="0" class="utable">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox runat="server" ID="txtUrl" CssClass="txtCls"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <th>
