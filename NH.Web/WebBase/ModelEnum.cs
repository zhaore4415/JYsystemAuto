...
namespace NH.Web.adm.WebBase
{
    public class ModelEnum
    {
        ...
        /// <param name="_status"></param>
        /// <returns></returns>
        public static string VerifyStatusDescc(VerifyStatus _status,int id)
        {
            string result = null;
            switch (_status)
            {
                case VerifyStatus.True:
                    result = "<span style='color:Blue'>审核通过</span> >><a href='/Member/CheckUid.aspx?Uid=" + id + "'>查看</a>";
                    break;
                case VerifyStatus.False:
                    result = "<span style='color:Red'>审核未通过</span> >><a href='/Member/CheckUid.aspx?Uid=" + id + "'>查看</a>";
                    break;
                case VerifyStatus.NoVerify:
                    result = "<span style='color:Red'>未审核</span> >><a href='/Member/CheckUid.aspx?Uid=" + id + "'>查看</a>";
                    break;
            }
            return result;
        }
