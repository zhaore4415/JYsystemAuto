<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="left.ascx.cs" Inherits="NH.Web.Admin_cssao.Controls.left" %>
    ...
    <div id="sidebar">
        ...
        <ul>
            ...
            <li class="<%=Request.Path.ToLower().Contains("/jifenlist") || Request.Path.ToLower().Contains("/authority/person/personlist") ? "active" : ""%>">
                <a href="/Admin_cssao/Authority/Person/PersonList.aspx" title="推荐库管理"><i class="icon icon-fullscreen"></i><span>推荐库管理</span></a></li>

            <li class="<%=Request.Path.ToLower().Contains("/queryorder") ? "active" : ""%>"><a
                href="/Admin_cssao/Authority/Queryorder/Queryorder.aspx" title="订单信息"><i class="icon icon-home"></i><span>订单信息</span></a>
            </li>
            <li class="<%=Request.Path.ToLower().Contains("/billmanage") || Request.Path.ToLower().Contains("/authority/bill/billmanage") ? "active" : ""%>">
                <a href="/Admin_cssao/authority/bill/billmanage.aspx" title="账单管理"><i class="icon icon-fullscreen"></i><span>账单管理</span></a></li>
            <li class="<%=Request.Path.ToLower().Contains("/jifenlist") || Request.Path.ToLower().Contains("/member/jifendetail") ? "active" : ""%>">
                <a href="/Admin_cssao/Member/JiFenList.aspx" title="退换货管理"><i class="icon icon-fullscreen"></i><span>退换货管理</span></a></li>
        </ul>
    </div>
</asp:Panel>
<asp:Panel ID="Panel2" runat="server">
    <div id="sidebar">
        ...
        <ul>
            ...
            <li class="<%=Request.Path.ToLower().Contains("/jifenlist") || Request.Path.ToLower().Contains("/member/jifendetail") ? "active" : ""%>">
                <a href="/Admin_cssao/Member/JiFenList.aspx" title="退换货管理"><i class="icon icon-fullscreen"></i><span>退换货管理</span></a></li>
            <li class="<%=Request.Path.ToLower().Contains("/auser") ? "active" : ""%>"><a href="/Admin_cssao/Authority/AUser/AUser.aspx"
