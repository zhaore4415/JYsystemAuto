<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KaoQinSetting.aspx.cs"
    Inherits="NH.Web.adm.Authority.Staff.KaoQinSetting" %>
        ...
        <table style="width: 100%" bgcolor="#999999" border="0" cellpadding="2" cellspacing="1">
            <tr>
                <td align="right" style="width: 267px; background-color: #e1f5fc; height: 30px;">
                    第<strong><span style="color: #ff0033"> 一 </span></strong>次登记规定时间(<span style="color: #0000ff">上班</span>)：
                </td>
            ...
            <tr>
                <td align="right" style="width: 267px; height: 30px; background-color: #e1f5fc">
                    第<strong><span style="color: #ff0033"> 二 </span></strong>次登记规定时间(<span style="color: #0000ff">下班</span>)：
                </td>
