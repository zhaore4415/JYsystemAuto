<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="AUserModify.aspx.cs"
    Inherits="NH.Web.adm.Authority.AUser.AUserModify" %>
                            ...
                            <table class="table table-bordered table-striped">
                                <tbody>
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td class="td-2">
                                            <input class="Wdate" type="text" onclick="WdatePicker()" name="Wdate" runat="server"
                                                id="Wdate" />
                                        </td>
                                    </tr>
                                    <tr class="odd gradeX">
