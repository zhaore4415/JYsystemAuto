<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JiFenDetail.aspx.cs" Inherits="NH.Web.adm.Authority.Integral.JiFenDetail"
        ...
        <div class="container-fluid">
            <div class="row-fluid">
                <div class="span12">
                    ...
                    </div><div class="dingdanliebiao"> <span> <asp:Button runat="server" ID="btnDelete" Text="删除" OnClick="btnDelete_Click" class="btn btn-inverse btn-mini" /></span></div>
                                                ...
                                                <table class="table table-bordered table-striped table-2">
                                                    <tbody>
                                                        ...
                                                        <tr class="odd gradeX">
                                                            ...
                                                            <td class="td-4">
                                                                <asp:Button runat="server" ID="btnSelect" Text="兑换" OnClick="btnSelect_Click" CssClass="btn btn-inverse btn-large" />
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
