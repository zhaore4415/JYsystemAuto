<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TextAdModify.aspx.cs" Inherits="NH.Web.adm.Ad.TextAdModify" %>
...
<body>    
    ...
    <div id="Add">
    <div class="frmborder">
            <p>广告管理 -> <a href="<%=ListUrl %>?<%=Request.QueryString.ToString() %>"><asp:Literal runat="server" ID="ltrTypeName"></asp:Literal></a> -> 修改</p>
        </div>
        <table width="100%" cellpadding="0" cellspacing="0" class="utable">
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList runat="server" ID="ddlIcon">
